...
import 'package:food_app/src/widgets/smalbutton.dart';
              ...
              Stack(
                ...
                borderRadius: BorderRadius.only(
                  ...
                  Positioned.fill(
                      ...
                      child: Align(
                          alignment: Alignment.bottomCenter,
                          child: CustomText(text: "Precio promedio: \$" + restaurantModel.avgPrice.toString(), color: white, size: 18, weight: FontWeight.w300,))),
...
//              open & book section
              Row(
                ...
                children: <Widget>[
                  CustomText(text: "Abierto", color: green, weight: FontWeight.w400, size: 18,),
                  Container(
                      child: FlatButton.icon(onPressed: (){}, icon: Icon(Icons.restaurant_menu), label: CustomText(text: "Reservar")))
                ],
              ),
              ...
              Column(
                children: productProvider.productsByRestaurant
                  ...
                  onTap: () {
                    changeScreen(context, Detail(product: item));
                  },
